    ...
    vec![
        ...
        ServerFrame::LobbyStatus(LobbyStatus {
            ...
            details: Some(LobbyDetails {
                ...
                min_players: 2,
                seats: vec![
                    SeatStatus { occupied: true, stale: false, bot: false, bot_fill: false, name: "bot-0".into() },
                    SeatStatus { occupied: true, stale: false, bot: false, bot_fill: true, name: "team-rocket".into() },
                    SeatStatus { occupied: true, stale: true, bot: false, bot_fill: false, name: "bot-2".into() },
                    SeatStatus { occupied: true, stale: false, bot: true, bot_fill: true, name: "Server-Bot 3".into() },
                ],
            }),
        }),

...
//!
//! Two packets are longer, and both are rare: the hello, which may carry a
//! name, and the seat-bot request (code 14), which names the seat it
//! configures.
...
pub use seat_bot::SeatBotRequest;

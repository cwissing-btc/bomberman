...
pub struct LobbySection {
    ...
    /// A player silent for this many seconds loses their seat. 0 disables it.
    pub drop_after_secs: u32,
    pub lobby_status_interval_ticks: u32,
    pub player_control: bool,
    /// Whether the server fills seats with bots of its own on request.
    pub server_bots: bool,
    /// Seats (0-based) filled with a server bot from startup on.
